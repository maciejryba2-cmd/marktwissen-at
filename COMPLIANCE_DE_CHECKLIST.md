# MarktWissen – Deutschland: Compliance-Handoff

## Zweck
Interne Checkliste für die Prüfung der deutschen CFD-Seiten vor Aktivierung von Affiliate-/Provider-Marketing.
...
- [ ] Keine pauschale Aussage „bester Broker“ ohne dokumentierte, freigegebene Methodik und belastbare aktuelle Daten.
- [ ] Keine künstliche Verknappung, Druck- oder FOMO-Sprache.
- [ ] Keine Incentives/Bonus-/Geschenkversprechen im Zusammenhang mit CFD-Marketing.
...
- [ ] Zuständige Aufsicht / regulatorischer Status verifiziert.
- [ ] Aktuelle Preis- und Gebührenquelle dokumentiert.
- [ ] Produktverfügbarkeit für deutsche Retail-Kunden verifiziert.
- [ ] Aktuelle Bedingungen/Terms dokumentiert.
- [ ] Angaben zu Hebel, Margin, Schutzmechanismen und weiteren Restriktionen verifiziert.
- [ ] Jede zeitabhängige Angabe hat eine dokumentierte Quelle und einen Review-Prozess.

## 4. Affiliate-Transparenz
- [ ] Affiliate-Beziehung wird klar und verständlich offengelegt.
- [ ] Vergütungslogik wird nicht als Qualitätsbeweis dargestellt.
...
- [ ] Drittanbieterbewertungen werden als individuelle Erfahrungen eingeordnet.
...
- [ ] Datenschutz vorhanden und geprüft.
- [ ] Risikohinweise erreichbar.
- [ ] Canonicals korrekt.
- [ ] Sitemap enthält nur beabsichtigte indexierbare URLs.
- [ ] Keine Test-/Placeholder-Seiten indexierbar.
